...
// CODE HERE
const evenNumbers  = mixedNumbers.filter((element,i)=> element%2 === 0)
...
// CODE HERE
const postTaxPrices  = prices.map((element, i) => element* 1.07)
...
// CODE HERE
const totalPopulation   = populations.reduce((acc, crr) => acc + crr)
...
// CODE HERE
const bobsTotal = purchases.filter((element,i) => element['owner'] === 'Bob').map((element,i) => element['price']).reduce((acc, curr) => acc + curr)
